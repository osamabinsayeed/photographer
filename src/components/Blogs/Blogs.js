...
const Blogs = () => {
    return (
        <div>
            <div><h2> Difference between authorization and authentication?</h2>
                <p>ans: Authorization means varifying users identity on the other hand Authentication means the proccess of determining which applications, files, data user has access to.</p></div>
            <div>
